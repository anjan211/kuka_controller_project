...
plot(data_real_A1.data(:,1)+0.020,data_real_A1.data(:,8));        %Shift Real robot trace by 0.020 towards right
hold off
...
plot(data_real_A2.data(:,1)+0.006,data_real_A2.data(:,9));        %Shift Real robot trace by 0.006 towards right
hold off
...
plot(data_real_A3.data(:,1)+0.017,data_real_A3.data(:,10));        %Shift Real robot trace by 0.017 towards right
hold off
...
plot(data_real_A4.data(:,1)+0.012,data_real_A4.data(:,11));        %Shift Real robot trace by 0.012 towards right
hold off
...
plot(data_real_A5.data(:,1)+0.02,data_real_A5.data(:,12));        %Shift Real robot trace by 0.02 towards right
hold off
...
plot(data_real_A6.data(:,1)+0.033,data_real_A6.data(:,13));        %Shift Real robot trace by 0.033 towards right
hold off
